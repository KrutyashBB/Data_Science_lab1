...
assert count_vowel_letters("") == 0, f"Ожидаемый ответ: 0, Текущий ответ: {count_vowel_letters('abbc')}"
...
assert count_vowel_letters("AaEEiUu") == 7, f"Ожидаемый ответ: 7, Текущий ответ: {count_vowel_letters('aeiiou')}"
